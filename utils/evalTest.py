...
imgDir      ='../data/v2_OpenEnded_mscoco_train2014_questions.json'
resultType  ='fake'
...
"""
vqaEval.evaluate(quesIds = [393271001, 399865002, 531047000, 531286006, 531299016])
